...
import com.physis.kit.module.ble.BuzzerBleActivity;
import com.physis.kit.module.dialog.LoadingDialog;

public class BuzzerMqttActivity extends PHYSIsMQTTActivity implements View.OnClickListener {

    private Button btnConnect, btnSetup, btnOn, btnOff;
    private EditText etSerialNum, etPubTopic, etVolume;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buzzer_mqtt);
    ...
    private void connect(){
        ...
        if(isConnected){
            ...
            LoadingDialog.show(BuzzerMqttActivity.this, "Connecting..");
            connectMQTT();
        }
    }
