...
public class BuzzerBleActivity extends PHYSIsBLEActivity implements View.OnClickListener {

    private static final String TAG = BuzzerBleActivity.class.getSimpleName();

    private Button btnConnect, btnSetup, btnOn, btnOff;
    private EditText etSerialNum, etVolume;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buzzer_ble);
    ...
    private void connect(){
        ...
        if(isConnected){
            ...
            LoadingDialog.show(BuzzerBleActivity.this, "Connecting..");
