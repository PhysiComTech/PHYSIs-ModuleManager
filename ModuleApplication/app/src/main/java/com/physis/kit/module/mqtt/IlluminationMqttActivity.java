...
public class IlluminationMqttActivity extends PHYSIsMQTTActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_illumination_mqtt);
    ...
    private void connect(){
        ...
        if(isConnected){
            ...
            LoadingDialog.show(IlluminationMqttActivity.this, "Connecting..");
            connectMQTT();
        }
    }
